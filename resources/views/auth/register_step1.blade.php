...
@section('content')
    ...
    <div class="mainContainerRegister">
        ...
        <div id="containerEmail" class="tab-content w-100 m-auto">
            <form method="POST" action="{{ route('register.step1.post') }}">
                ...
                <button id="primoStepBtnRegister" type="submit" class="btn btn-primary w-100 mt-4">Avanti</button>
            </form>
        </div>
    ...
    <script>
        const primoStepBtnRegisterElem = document.getElementById('primoStepBtnRegister');

        primoStepBtnRegisterElem..addEventListener('click', function(e) {
            e.preventDefault();
        });
    </script>
